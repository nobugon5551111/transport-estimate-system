...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (currentPath.includes('/estimate')) {
    ...
    // STEP4の初期化 - URLパラメータも考慮
    const shouldInitStep4 = currentPath === '/estimate/step4' || (currentPath === '/estimate/new' && currentStep === '4');
    console.log('🔍 DEBUG: Step4初期化判定');
    console.log('  - currentPath === "/estimate/step4":', currentPath === '/estimate/step4');
    console.log('  - currentPath === "/estimate/new":', currentPath === '/estimate/new');
    console.log('  - currentStep === "4":', currentStep === '4');
    console.log('  - shouldInitStep4:', shouldInitStep4);
    
    if (shouldInitStep4) {
      console.log('🚀 STEP4初期化を開始します...');
      Step4Implementation.initialize();
    } else {
      console.log('⏸️ STEP4初期化条件に一致しませんでした');
    }

    // STEP5の初期化 - URLパラメータも考慮
    if (currentPath === '/estimate/step5' || (currentPath === '/estimate/new' && currentStep === '5')) {
      console.log('🚀 STEP5初期化を開始します...');
      Step5Implementation.initialize();
    }

    // STEP6の初期化 - URLパラメータも考慮
    if (currentPath === '/estimate/step6' || (currentPath === '/estimate/new' && currentStep === '6')) {
      console.log('🚀 STEP6初期化を開始します...');
