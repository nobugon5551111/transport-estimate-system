...
const Step4Implementation = {
  ...
  setMasterRatesToInputFields: (masterStaffRates) => {
    console.log('🔄 マスターデータを入力フィールドに自動設定開始', masterStaffRates);
    
    try {
      // スタッフ単価の入力フィールドにマスターデータを設定
      const rateFields = [
        { id: 'rate_supervisor', value: masterStaffRates.supervisor || 40000 },
        { id: 'rate_leader', value: masterStaffRates.leader || 12000 },
        { id: 'rate_m2_half_day', value: masterStaffRates.m2_half_day || 6000 },
        { id: 'rate_m2_full_day', value: masterStaffRates.m2_full_day || 10000 },
        { id: 'rate_temp_half_day', value: masterStaffRates.temp_half_day || 5500 },
        { id: 'rate_temp_full_day', value: masterStaffRates.temp_full_day || 9500 }
      ];
      ...
      console.log('✅ マスターデータの入力フィールド自動設定完了');
    } catch (error) {
      console.error('❌ マスターデータ自動設定エラー:', error);
    }
  },

  // 🔄 デフォルト値を入力フィールドに設定する関数
  setDefaultRatesToInputFields: () => {
    console.log('🔄 デフォルト値を入力フィールドに設定開始');
    
    try {
      const defaultRates = [
        { id: 'rate_supervisor', value: 40000 },
        { id: 'rate_leader', value: 12000 },
        { id: 'rate_m2_half_day', value: 6000 },
        { id: 'rate_m2_full_day', value: 10000 },
        { id: 'rate_temp_half_day', value: 5500 },
        { id: 'rate_temp_full_day', value: 9500 }
      ];
      ...
      console.log('✅ デフォルト値の入力フィールド設定完了');
    } catch (error) {
      console.error('❌ デフォルト値設定エラー:', error);
    }
  }
};
...
const Step5Implementation = {
  ...
  setMasterRatesToInputFields: (masterRates) => {
    console.log('🔄 Step5: マスターデータを入力フィールドに自動設定開始', masterRates);
    
    try {
      // サービス単価の入力フィールドにマスターデータを設定
      const serviceFields = [
        { id: 'service_parking_officer_hourly', value: masterRates.parking_officer_hourly || 3000 },
        { id: 'service_transport_20km', value: masterRates.transport_20km || 8000 },
        { id: 'service_transport_per_km', value: masterRates.transport_per_km || 100 },
        { id: 'service_fuel_per_liter', value: masterRates.fuel_per_liter || 150 },
        { id: 'service_waste_small', value: masterRates.waste_small || 5000 },
        { id: 'service_waste_medium', value: masterRates.waste_medium || 10000 },
        { id: 'service_waste_large', value: masterRates.waste_large || 20000 },
        { id: 'service_material_few', value: masterRates.material_few || 3000 },
        { id: 'service_material_medium', value: masterRates.material_medium || 8000 },
        { id: 'service_material_many', value: masterRates.material_many || 15000 },
        { id: 'service_protection_base', value: masterRates.protection_base || 5000 },
        { id: 'service_protection_floor', value: masterRates.protection_floor || 3000 },
        { id: 'service_construction_m2_staff_rate', value: masterRates.construction_m2_staff_rate || 8000 }
      ];
      ...
      console.log('✅ Step5: マスターデータの入力フィールド自動設定完了');
    } catch (error) {
  ...
  // 🔄 デフォルト値を入力フィールドに設定する関数
  setDefaultRatesToInputFields: () => {
    console.log('🔄 Step5: デフォルト値を入力フィールドに設定開始');
    
    try {
      const defaultServiceRates = [
        { id: 'service_parking_officer_hourly', value: 3000 },
        { id: 'service_transport_20km', value: 8000 },
        { id: 'service_transport_per_km', value: 100 },
        { id: 'service_fuel_per_liter', value: 150 },
        { id: 'service_waste_small', value: 5000 },
        { id: 'service_waste_medium', value: 10000 },
        { id: 'service_waste_large', value: 20000 },
        { id: 'service_material_few', value: 3000 },
        { id: 'service_material_medium', value: 8000 },
        { id: 'service_material_many', value: 15000 },
        { id: 'service_protection_base', value: 5000 },
        { id: 'service_protection_floor', value: 3000 },
        { id: 'service_construction_m2_staff_rate', value: 8000 }
      ];
      ...
      console.log('✅ Step5: デフォルト値の入力フィールド設定完了');
    } catch (error) {
