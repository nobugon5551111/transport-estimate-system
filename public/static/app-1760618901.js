...
console.log('🚀 JavaScript Version: 1760678720 - 動的ラベル更新機能追加済み');
...
const Step4Implementation = {
  ...
  setMasterRatesToInputFields: (masterStaffRates) => {
    console.log('🔄 Step4: マスターデータを入力フィールド＆ラベル表示に自動設定開始', masterStaffRates);
    ...
    try {
      ...
      const rateFields = [
        ...
        { id: 'rate_temp_half_day', value: masterStaffRates.temp_half_day || 5500, displayId: 'rate-display-temp-half' },
        { id: 'rate_temp_full_day', value: masterStaffRates.temp_full_day || 9500, displayId: 'rate-display-temp-full' }
      ];
      ...
      rateFields.forEach(field => {
        ...
        if (inputElement) {
          ...
          console.log(`✅ ${field.id}: ${field.value}円 設定完了`);
        } else {
      ...
      console.log('✅ Step4: マスターデータの入力フィールド＆ラベル表示自動設定完了');
    } catch (error) {
      console.error('❌ Step4: マスターデータ自動設定エラー:', error);
    }
  },

  // 🔄 デフォルト値を入力フィールドに設定する関数
  setDefaultRatesToInputFields: () => {
    console.log('🔄 Step4: デフォルト値を入力フィールド＆ラベル表示に設定開始');
    
    try {
      const defaultRates = [
        { id: 'rate_supervisor', value: 40000, displayId: 'rate-display-supervisor' },
        { id: 'rate_leader', value: 12000, displayId: 'rate-display-leader' },
        { id: 'rate_m2_half_day', value: 6000, displayId: 'rate-display-m2-half' },
        { id: 'rate_m2_full_day', value: 10000, displayId: 'rate-display-m2-full' },
        { id: 'rate_temp_half_day', value: 5500, displayId: 'rate-display-temp-half' },
        { id: 'rate_temp_full_day', value: 9500, displayId: 'rate-display-temp-full' }
      ];
      ...
      console.log('✅ Step4: デフォルト値の入力フィールド＆ラベル表示設定完了');
    } catch (error) {
...
const Step5Implementation = {
  ...
  setMasterRatesToInputFields: (masterRates) => {
    console.log('🔄 Step5: マスターデータを入力フィールド＆ラベル表示に自動設定開始', masterRates);
    
    try {
      // サービス単価の入力フィールドにマスターデータを設定
      const serviceFields = [
        { id: 'service_parking_officer_hourly', value: masterRates.parking_officer_hourly || 3000, displayId: 'rate-display-parking-hourly' },
        { id: 'service_transport_20km', value: masterRates.transport_20km || 8000, displayId: 'rate-display-transport-20km' },
        { id: 'service_transport_per_km', value: masterRates.transport_per_km || 100, displayId: 'rate-display-transport-km' },
        { id: 'service_fuel_per_liter', value: masterRates.fuel_per_liter || 150, displayId: 'rate-display-fuel' },
        { id: 'service_waste_small', value: masterRates.waste_small || 5000, displayId: 'rate-display-waste-small' },
        { id: 'service_waste_medium', value: masterRates.waste_medium || 10000, displayId: 'rate-display-waste-medium' },
        { id: 'service_waste_large', value: masterRates.waste_large || 20000, displayId: 'rate-display-waste-large' },
        { id: 'service_material_few', value: masterRates.material_few || 3000, displayId: null }, // 残材回収は表示ラベルなし
        { id: 'service_material_medium', value: masterRates.material_medium || 8000, displayId: null },
        { id: 'service_material_many', value: masterRates.material_many || 15000, displayId: null },
        { id: 'service_protection_base', value: masterRates.protection_base || 5000, displayId: 'rate-display-protection-base' },
        { id: 'service_protection_floor', value: masterRates.protection_floor || 3000, displayId: 'rate-display-protection-floor' },
        { id: 'service_construction_m2_staff_rate', value: masterRates.construction_m2_staff_rate || 8000, displayId: 'rate-display-construction-m2' }
      ];
      ...
      console.log('✅ Step5: マスターデータの入力フィールド＆ラベル表示自動設定完了');
    } catch (error) {
  ...
  // 🔄 デフォルト値を入力フィールドに設定する関数
  setDefaultRatesToInputFields: () => {
    console.log('🔄 Step5: デフォルト値を入力フィールド＆ラベル表示に設定開始');
    
    try {
      const defaultServiceRates = [
        { id: 'service_parking_officer_hourly', value: 3000, displayId: 'rate-display-parking-hourly' },
        { id: 'service_transport_20km', value: 8000, displayId: 'rate-display-transport-20km' },
        { id: 'service_transport_per_km', value: 100, displayId: 'rate-display-transport-km' },
        { id: 'service_fuel_per_liter', value: 150, displayId: 'rate-display-fuel' },
        { id: 'service_waste_small', value: 5000, displayId: 'rate-display-waste-small' },
        { id: 'service_waste_medium', value: 10000, displayId: 'rate-display-waste-medium' },
        { id: 'service_waste_large', value: 20000, displayId: 'rate-display-waste-large' },
        { id: 'service_material_few', value: 3000, displayId: null },
        { id: 'service_material_medium', value: 8000, displayId: null },
        { id: 'service_material_many', value: 15000, displayId: null },
        { id: 'service_protection_base', value: 5000, displayId: 'rate-display-protection-base' },
        { id: 'service_protection_floor', value: 3000, displayId: 'rate-display-protection-floor' },
        { id: 'service_construction_m2_staff_rate', value: 8000, displayId: 'rate-display-construction-m2' }
      ];

      defaultServiceRates.forEach(field => {
        // 入力フィールドの値を設定
        const inputElement = document.getElementById(field.id);
        if (inputElement) {
          inputElement.value = field.value;
      ...
      console.log('✅ Step5: デフォルト値の入力フィールド＆ラベル表示設定完了');
    } catch (error) {
